// Command YaglaUrlShortener-cli is a CLI + REPL for the YaglaUrlShortener SDK,
...
const prompt = "yagla-url-shortener"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      YAGLA_URL_SHORTENER_APIKEY (api key), YAGLA_URL_SHORTENER_BASE (base url override)")
