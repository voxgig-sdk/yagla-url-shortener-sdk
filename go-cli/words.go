...
func registerSDKWords(r *eng.Registry, client *sdk.YaglaUrlShortenerSDK) {
...
func runOp(client *sdk.YaglaUrlShortenerSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
