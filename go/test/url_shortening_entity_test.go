...
func TestUrlShorteningEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		urlShorteningRef01Data = core.ToMapAny(entityData(urlShorteningRef01DataResult))
...
func url_shorteningBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("YAGLA_URL_SHORTENER_TEST_URL_SHORTENING_ENTID")
	...
	idmapResolved := core.ToMapAny(env["YAGLA_URL_SHORTENER_TEST_URL_SHORTENING_ENTID"])
