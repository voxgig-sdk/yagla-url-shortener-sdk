...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("YAGLAURLSHORTENER_TEST_LIVE") == "TRUE" ||
		os.Getenv("YAGLAURLSHORTENER_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("YAGLAURLSHORTENER_TEST_EXPLAIN"); explain != "" {
