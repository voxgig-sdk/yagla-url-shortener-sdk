...
func registerTools(server *mcp.Server, client *sdk.YaglaUrlShortenerSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "yagla-url-shortener_list",
		Description: "List records from YaglaUrlShortener. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "yagla-url-shortener_load",
		Description: "Load a single record from YaglaUrlShortener. " +
...
func runOp(client *sdk.YaglaUrlShortenerSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.YaglaUrlShortenerSDK, name string) (sdk.YaglaUrlShortenerEntity, error) {
