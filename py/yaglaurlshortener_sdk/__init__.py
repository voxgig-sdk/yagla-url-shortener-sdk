...
from yaglaurlshortener_sdk.utility import register

# Load features
from yaglaurlshortener_sdk.feature.base_feature import YaglaUrlShortenerBaseFeature
from yaglaurlshortener_sdk.features import _has_feature, _make_feature
...
class YaglaUrlShortenerSDK:
    ...
    def get_utility(self):
        return YaglaUrlShortenerUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("YaglaUrlShortenerSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def UrlShortening(self, data=None) -> "UrlShorteningEntity":
        ...
        from yaglaurlshortener_sdk.entity.url_shortening_entity import UrlShorteningEntity
        return UrlShorteningEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "YaglaUrlShortenerSDK":
        if sdkopts is None:
            sdkopts = {}
