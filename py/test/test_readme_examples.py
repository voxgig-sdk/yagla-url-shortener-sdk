# YaglaUrlShortener SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions YaglaUrlShortenerSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both YaglaUrlShortenerSDK(...) and YaglaUrlShortenerSDK.test(...) become
#      YaglaUrlShortenerSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "yaglaurlshortener_sdk"
_SDK_CLASS = "YaglaUrlShortenerSDK"
