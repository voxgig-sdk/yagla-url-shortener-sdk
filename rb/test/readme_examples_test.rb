...
#      offline in seeded test mode (YaglaUrlShortenerSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "YaglaUrlShortener_sdk.rb")
  SDK_CLASS = "YaglaUrlShortenerSDK"
  ...
  SDK_BASE = "YaglaUrlShortener_sdk"
