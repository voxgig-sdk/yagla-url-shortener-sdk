...
// YaglaUrlShortener SDK utility: result_basic

class YaglaUrlShortenerResultBasic
{
    public static function call(YaglaUrlShortenerContext $ctx): ?YaglaUrlShortenerResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof YaglaUrlShortenerError) ? $result->err->msg : (string)$result->err;
