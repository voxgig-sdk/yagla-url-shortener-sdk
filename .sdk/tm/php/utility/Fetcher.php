...
// YaglaUrlShortener SDK utility: fetcher

class YaglaUrlShortenerFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; YaglaUrlShortenerSDK/1.0)';
    ...
    public static function call(YaglaUrlShortenerContext $ctx, string $fullurl, array $fetchdef): array
    {
