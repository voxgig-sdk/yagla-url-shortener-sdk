...
// YaglaUrlShortener SDK utility: graphql
//
...
class YaglaUrlShortenerGraphql
{
    ...
    // equivalent.
    public static function body(YaglaUrlShortenerContext $ctx): mixed
    {
    ...
    public static function errors(YaglaUrlShortenerContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
