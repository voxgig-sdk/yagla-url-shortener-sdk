...
// YaglaUrlShortener SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class YaglaUrlShortenerTransformResponse
{
    public static function call(YaglaUrlShortenerContext $ctx): mixed
    {
        ...
        $transform = YaglaUrlShortenerHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
