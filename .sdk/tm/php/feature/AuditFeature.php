...
// YaglaUrlShortener SDK audit feature
...
class YaglaUrlShortenerAuditFeature extends YaglaUrlShortenerBaseFeature
{
    ...
    private function _emit(YaglaUrlShortenerContext $ctx, string $outcome): void
    {
