...
// YaglaUrlShortener SDK ratelimit feature
...
class YaglaUrlShortenerRatelimitFeature extends YaglaUrlShortenerBaseFeature
{
    ...
    private function _acquire(YaglaUrlShortenerContext $ctx): void
    {
    ...
    private function _track(YaglaUrlShortenerContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
