...
// YaglaUrlShortener SDK streaming feature
...
class YaglaUrlShortenerStreamingFeature extends YaglaUrlShortenerBaseFeature
{
    ...
    private function _iterate(YaglaUrlShortenerResult $result): \Generator
    {
    ...
    private function _streamable(YaglaUrlShortenerContext $ctx): bool
    {
