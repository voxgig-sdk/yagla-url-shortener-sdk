...
// YaglaUrlShortener SDK proxy feature
...
class YaglaUrlShortenerProxyFeature extends YaglaUrlShortenerBaseFeature
{
    ...
    public function init(YaglaUrlShortenerContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (YaglaUrlShortenerContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
