...
// YaglaUrlShortener SDK telemetry feature
...
class YaglaUrlShortenerTelemetryFeature extends YaglaUrlShortenerBaseFeature
{
    ...
    private function _close(YaglaUrlShortenerContext $ctx, bool $ok): void
    {
