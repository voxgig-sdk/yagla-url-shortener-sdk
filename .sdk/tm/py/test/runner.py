...
class YaglaUrlShortenerTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = YaglaUrlShortenerTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = YaglaUrlShortenerTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = YaglaUrlShortenerTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
