...
class YaglaUrlShortenerContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = YaglaUrlShortenerControl()
        ...
        if isinstance(sp, YaglaUrlShortenerSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, YaglaUrlShortenerResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, YaglaUrlShortenerResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return YaglaUrlShortenerOperation({})
    ...
    def make_error(self, code, msg):
        return YaglaUrlShortenerError(code, msg, self)
