...
local function make_error_util(ctx, err)
  ...
  local msg = "YaglaUrlShortenerSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = YaglaUrlShortenerError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == YaglaUrlShortenerError then
