...
// YaglaUrlShortener SDK utility type

class YaglaUrlShortenerUtility
{
    ...
    public static function copy(YaglaUrlShortenerUtility $src): YaglaUrlShortenerUtility
    {
        $u = new YaglaUrlShortenerUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
