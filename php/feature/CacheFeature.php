...
// YaglaUrlShortener SDK cache feature
...
class YaglaUrlShortenerCacheFeature extends YaglaUrlShortenerBaseFeature
{
    ...
    private function _through(YaglaUrlShortenerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
