...
// YaglaUrlShortener SDK timeout feature
...
class YaglaUrlShortenerTimeoutFeature extends YaglaUrlShortenerBaseFeature
{
    ...
    private function _with_timeout(YaglaUrlShortenerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(YaglaUrlShortenerContext $_ctx, float $ms): void
    {
        $client = $this->client;
