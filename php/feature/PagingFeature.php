...
// YaglaUrlShortener SDK paging feature
...
class YaglaUrlShortenerPagingFeature extends YaglaUrlShortenerBaseFeature
{
    ...
    private function _is_list(YaglaUrlShortenerContext $ctx): bool
    {
