...
// YaglaUrlShortener SDK debug feature
...
class YaglaUrlShortenerDebugFeature extends YaglaUrlShortenerBaseFeature
{
    ...
    private function _finish(YaglaUrlShortenerContext $ctx, bool $ok): void
    {
