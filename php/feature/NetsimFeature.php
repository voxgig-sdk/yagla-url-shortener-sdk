...
// YaglaUrlShortener SDK netsim feature
...
class YaglaUrlShortenerNetsimFeature extends YaglaUrlShortenerBaseFeature
{
    ...
    private function _simulate(YaglaUrlShortenerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(YaglaUrlShortenerContext $ctx, array $applied): void
    {
        $client = $this->client;
