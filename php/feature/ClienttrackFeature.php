...
// YaglaUrlShortener SDK clienttrack feature
...
class YaglaUrlShortenerClienttrackFeature extends YaglaUrlShortenerBaseFeature
{
    ...
    public function PostConstruct(YaglaUrlShortenerContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'YaglaUrlShortener-SDK';
