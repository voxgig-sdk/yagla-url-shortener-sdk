...
// YaglaUrlShortener SDK idempotency feature
...
class YaglaUrlShortenerIdempotencyFeature extends YaglaUrlShortenerBaseFeature
{
    ...
    private function _mutating(YaglaUrlShortenerContext $ctx): bool
    {
