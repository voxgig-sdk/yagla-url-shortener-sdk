...
// YaglaUrlShortener SDK metrics feature
...
class YaglaUrlShortenerMetricsFeature extends YaglaUrlShortenerBaseFeature
{
    ...
    private function _record(YaglaUrlShortenerContext $ctx, bool $ok): void
    {
