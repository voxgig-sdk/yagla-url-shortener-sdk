...
// YaglaUrlShortener SDK rbac feature
...
class YaglaUrlShortenerRbacFeature extends YaglaUrlShortenerBaseFeature
{
    ...
    private function _required(YaglaUrlShortenerContext $ctx): ?string
    {
    ...
    private function _reject(YaglaUrlShortenerContext $ctx, string $required): void
    {
    ...
    private function _track(YaglaUrlShortenerContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
