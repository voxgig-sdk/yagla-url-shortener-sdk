...
// YaglaUrlShortener SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class YaglaUrlShortenerMakeRequest
{
    public static function call(YaglaUrlShortenerContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new YaglaUrlShortenerResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new YaglaUrlShortenerResponse($fetched);
        } else {
