...
// YaglaUrlShortener SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (YaglaUrlShortenerSDK::test)
...
{
    private const SDK_CLASS = 'YaglaUrlShortenerSDK';
    ...
    private const SDK_BASE = 'yaglaurlshortener_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../yaglaurlshortener_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
