...
// YaglaUrlShortener SDK pipeline test
//
...
{
    private static function utility(): YaglaUrlShortenerUtility
    {
        return new YaglaUrlShortenerUtility();
    }
    ...
    private static function ctx(array $over = []): YaglaUrlShortenerContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new YaglaUrlShortenerContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new YaglaUrlShortenerOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof YaglaUrlShortenerError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new YaglaUrlShortenerOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = YaglaUrlShortenerMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new YaglaUrlShortenerOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = YaglaUrlShortenerMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new YaglaUrlShortenerOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = YaglaUrlShortenerMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new YaglaUrlShortenerSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = YaglaUrlShortenerMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new YaglaUrlShortenerResponse([]),
            'result' => new YaglaUrlShortenerResult([]),
        ]);
        [, $err] = YaglaUrlShortenerMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new YaglaUrlShortenerSpec([]),
            'response' => null,
            'result' => new YaglaUrlShortenerResult([]),
        ]);
        [, $err] = YaglaUrlShortenerMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new YaglaUrlShortenerSpec(['step' => 's']),
            'response' => new YaglaUrlShortenerResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new YaglaUrlShortenerResult([]),
        ]);
        [, $err] = YaglaUrlShortenerMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new YaglaUrlShortenerSpec(['step' => 's']),
            'response' => new YaglaUrlShortenerResponse(self::resp(200, ['v' => 1])),
            'result' => new YaglaUrlShortenerResult([]),
        ]);
        [, $err] = YaglaUrlShortenerMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new YaglaUrlShortenerSpec(['step' => 's']),
            'response' => new YaglaUrlShortenerResponse(self::resp(200, ['v' => 2])),
            'result' => new YaglaUrlShortenerResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        YaglaUrlShortenerMakeResponse::call($ctx);
    ...
    {
        $preset = new YaglaUrlShortenerResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new YaglaUrlShortenerSpec([]),
            'response' => new YaglaUrlShortenerResponse([]),
            'result' => new YaglaUrlShortenerResult([]),
        ...
        [$got, $err] = YaglaUrlShortenerMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new YaglaUrlShortenerResult([])]);
        [, $err] = YaglaUrlShortenerMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new YaglaUrlShortenerSpec([]), 'result' => null]);
        [, $err] = YaglaUrlShortenerMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new YaglaUrlShortenerSpec(['step' => 's']),
            'result' => new YaglaUrlShortenerResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new YaglaUrlShortenerOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = YaglaUrlShortenerMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new YaglaUrlShortenerSpec(['step' => 's']),
            'result' => new YaglaUrlShortenerResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new YaglaUrlShortenerOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = YaglaUrlShortenerMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new YaglaUrlShortenerResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new YaglaUrlShortenerSpec([]),
            'result' => new YaglaUrlShortenerResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = YaglaUrlShortenerMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = YaglaUrlShortenerMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new YaglaUrlShortenerError('boom', 'boom');
        $utility->fetcher = function (YaglaUrlShortenerContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new YaglaUrlShortenerSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = YaglaUrlShortenerMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (YaglaUrlShortenerContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = YaglaUrlShortenerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(YaglaUrlShortenerResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        YaglaUrlShortenerMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (YaglaUrlShortenerContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new YaglaUrlShortenerSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = YaglaUrlShortenerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new YaglaUrlShortenerResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new YaglaUrlShortenerSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = YaglaUrlShortenerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = YaglaUrlShortenerMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = YaglaUrlShortenerMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new YaglaUrlShortenerResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, YaglaUrlShortenerDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new YaglaUrlShortenerResult(['ok' => false])]);
        $this->expectException(YaglaUrlShortenerError::class);
        YaglaUrlShortenerDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new YaglaUrlShortenerResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', YaglaUrlShortenerMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        YaglaUrlShortenerMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new YaglaUrlShortenerBaseFeature();
        $b = new YaglaUrlShortenerBaseFeature();
        YaglaUrlShortenerFeatureAdd::call($ctx, $a);
        YaglaUrlShortenerFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): YaglaUrlShortenerBaseFeature
    {
        $f = new YaglaUrlShortenerBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        YaglaUrlShortenerFeatureAdd::call($ctx, self::named_feature('a'));
        YaglaUrlShortenerFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        YaglaUrlShortenerFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        YaglaUrlShortenerFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        YaglaUrlShortenerFeatureAdd::call($ctx, $replace);
        ...
        YaglaUrlShortenerFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): YaglaUrlShortenerContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new YaglaUrlShortenerSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = YaglaUrlShortenerPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        YaglaUrlShortenerPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new YaglaUrlShortenerResponse(['headers' => null]),
            'result' => new YaglaUrlShortenerResult([]),
        ]);
        YaglaUrlShortenerResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        YaglaUrlShortenerResultBody::call($ctx);
