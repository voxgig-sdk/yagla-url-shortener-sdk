...
function envOverride(m) {
    if ('TRUE' === process.env.YAGLA_URL_SHORTENER_TEST_LIVE ||
        'TRUE' === process.env.YAGLA_URL_SHORTENER_TEST_OVERRIDE) {
    ...
    m.YAGLA_URL_SHORTENER_TEST_EXPLAIN = process.env.YAGLA_URL_SHORTENER_TEST_EXPLAIN || m.YAGLA_URL_SHORTENER_TEST_EXPLAIN;
    return m;
}
