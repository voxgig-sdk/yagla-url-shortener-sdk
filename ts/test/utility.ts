...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.YAGLAURLSHORTENER_TEST_LIVE ||
    'TRUE' === process.env.YAGLAURLSHORTENER_TEST_OVERRIDE
  ) {
  ...
  m.YAGLAURLSHORTENER_TEST_EXPLAIN = process.env.YAGLAURLSHORTENER_TEST_EXPLAIN || m.YAGLAURLSHORTENER_TEST_EXPLAIN
